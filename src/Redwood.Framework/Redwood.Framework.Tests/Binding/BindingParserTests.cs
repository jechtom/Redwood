...
namespace Redwood.Framework.Tests.Binding
{
    ...
    public class BindingParserTests
    {
        ...
        public void BindingParser_NoParameters()
        {
            ...
            var binding = (BindingMarkupExtension)parser.ParseExpression("Binding");
        ...
        {
            var parser = new BindingParser();
            var binding = (BindingMarkupExtension)parser.ParseExpression("Binding Test.Test2, Mode=TwoWay");
        ...
        {
            var parser = new BindingParser();
            var binding = (BindingMarkupExtension)parser.ParseExpression("Binding Path=Test.Test2");
