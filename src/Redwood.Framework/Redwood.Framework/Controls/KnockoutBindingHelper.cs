...
namespace Redwood.Framework.Controls
{
    ...
    {
        public static bool IsKnockoutBinding(BindingExpression expr)
        {
            if(expr == null)
                return false;
        ...
        public static BindingExpression GetExpressionOrNull(RedwoodProperty property, RedwoodBindable obj)
        {
